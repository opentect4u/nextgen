...
function ExistingPoView() {
    ...
    return (
     ...
     {po_data.length>0 &&  <div className="flex flex-col p-1 bg-blue-900 rounded-full my-3 dark:bg-[#22543d] md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 ">
  ...
  <div class="relative overflow-x-auto">
    {loading?<SkeletonLoading/>:po_data.length>0 && (
      <table class="w-full text-sm text-left rtl:text-right shadow-lg text-blue-900 dark:text-gray-400">
          <thead class=" text-md  text-gray-700 capitalize   bg-blue-400 dark:bg-gray-700 dark:text-gray-400">
              <tr >
