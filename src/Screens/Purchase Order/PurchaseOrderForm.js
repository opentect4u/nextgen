...
function PurchaseOrderForm() {
  ...
  const steps = [
              ...
              <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    placeholder="Your address here" disabled
                  >
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    rows="8"
                    className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  focus:border-green-900 active:border-green-900 focus:ring-green-900 focus:border-1 duration-300 dark:focus:ring-green-900 dark:focus:border-green-900"
                    placeholder="Your address here" disabled={type=='G'||deliveryConfirm}
                  >
                    {/* {delivery} */}
                    {type == 'G' || deliveryConfirm? 'NextGen Automation Pvt Ltd Unit - 102, 1st Floor, PS PACE 1/1A, Mahendra Roy Lane Kolkata 700046':''}
                  </textarea>
                </div>
              </div>
            </form>
      ...
      content: (
        <div className="grid gap-4 sm:grid-cols-4 sm:gap-6">
          ...
          <div className=" flex justify-between sm:col-span-1 sm:flex sm:justify-center mt-5">
            ...
            <Switch size="large" value={insp} onChange={e=>setInsp(e)} defaultChecked />
          </div>
          <div className="flex justify-between sm:col-span-1 sm:flex sm:justify-center mt-5">
            <label
              for="brand"
            ...
            <Switch size="large" value={drawing} onChange={e=>setDrawing(e)} defaultChecked />
          </div>
          <div className="flex justify-between  sm:col-span-1 sm:flex sm:justify-center mt-5">
            <label
              for="brand"
        ...
        {drawing &&  <div className=" sm:col-span-4 mt-6">
            <label
              for="catnm"
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            >
         ...
         {insp && <div className="sm:col-span-4">
            <label
              for="catnm"
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            >
    ...
    },
    {
      ...
      content: (
        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
          <iframe className="col-span-2 w-full h-full" src={PDF} title="W3Schools Free Online Web Tutorials"></iframe>
        </div>
      ),
    },
    {
