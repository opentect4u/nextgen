...
const DesignationComp =lazy(()=>import('./Screens/Masters/Designation/DesignationComp'))
const DesignationView =lazy(()=>import('./Screens/Masters/Designation/DesignationView'))
const DesignationForm =lazy(()=>import('./Screens/Masters/Designation/DesignationForm'))

const PurchaseOrderComp = lazy(()=>import( './Screens/Purchase Order/PurchaseOrderComp'));
const PurchaseOrderView = lazy(()=>import('./Screens/Purchase Order/PurchaseOrderView')) ;
const PurchaseOrderForm = lazy(()=>import('./Screens/Purchase Order/PurchaseOrderForm'))
...
const RequisitionSentView = lazy(()=>import('./Screens/Stock/RequisitionSentView'))
const RequisitionRcvdView = lazy(()=>import('./Screens/Stock/RequisitionRcvdView'))
  ...
  <Democontext>
      ...
      <>
                   ...
                   <Skeleton className="mb-2 w-full" height="6rem"></Skeleton>
                    ...
                    <Skeleton className='m-1 w-96' height='40rem'></Skeleton>
                    </div>
