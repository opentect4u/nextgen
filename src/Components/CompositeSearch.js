      ...
      {set_one_val && set_two_val && (
        ...
        >
          ...
          >
            <span className="mr-2">
              {" "}
              {data?.set_one.filter((e) => e.code == set_one_val)[0]?.name}{" "}
            </span>
            <span>
              {data?.set_two.filter((e) => e.code == set_two_val)[0]?.name}{" "}
            </span>
          </Tag>
        </motion.div>
      )}
        ...
        <div className="flex gap-4 justify-between">
          ...
          <button
            ...
            disabled={
              !set_one_val ||
              !set_two_val ||
              set_one_val == `Select ${data?.set_one_lbl}` ||
              set_two_val == `Select ${data?.set_two_lbl}`
            }
