    ...
    <div className="flex flex-col p-1 bg-green-900 rounded-full my-3 dark:bg-[#22543d] md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 ">
           ...
           <table class="w-full text-sm text-left rtl:text-right shadow-lg text-green-900dark:text-gray-400">
                 ...
                 <tbody>
                    ...
                    <tr class={item.modified_at==null?(+Math.floor(((new Date().getTime() - new Date(item.created_at).getTime())/1000))<1800?"bg-[#ffe4c4] duration-500 delay-700 border-b dark:bg-gray-800 dark:border-gray-700":"bg-white border-b dark:bg-gray-800 dark:border-gray-700"):(+Math.floor(((new Date().getTime() - new Date(item.modified_at).getTime())/1000))<1800?"bg-[#ffe4c4] border-b dark:bg-gray-800 duration-500 dark:border-gray-700":"bg-white border-b dark:bg-gray-800 dark:border-gray-700")}>
