...
async def save_trans(data:GetTransItem):
    res_dt = {}
    select = "t.sl_no,t.trans_no,t.item_id,t.qty, t.created_at, t.approve_flag,p.prod_name,t.approved_by"
...
async def getprojectpoc(id:GetStock):
    ...
    select1 = f"sum(i.approved_qty) - sum(i.cancelled_qty) as req_stock"
    ...
    select_tot = f"sum(i.approved_qty) - sum(i.cancelled_qty) as tot_stock"
