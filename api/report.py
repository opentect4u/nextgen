...
async def getprojectpoc(id:mrnprojreport):
    ...
    select =f"DISTINCT i.item_id, p.prod_name, pb.po_no, i.quantity,pi.approved_ord_qty, d.rc_qty,d.mrn_no,d.invoice,pb.pur_req,v.vendor_name,COALESCE(pd.proj_name, 'Warehouse') AS proj_name" if id.type=='P' else f"DISTINCT i.item_id, p.prod_name, i.quantity, d.rc_qty,d.mrn_no,d.invoice,pi.approved_ord_qty,pb.pur_req,'Warehouse' as proj_name,v.vendor_name"
