...
async def getprojectpoc(id:GetStockOut):
    ...
    for i in result_stck1['msg']:
        ...
        select_req = f"i.req_qty, i.req_qty as copy_qty,r.req_no as req_no,i.item_id,r.project_id,(select sum(qty) from td_stock_new st where st.item_id={i['item_id']} and st.proj_id={id.proj_id} and st.ref_no=r.req_no) del_qty, (copy_qty-del_qty) as qty"
