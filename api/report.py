...
async def getprojectpoc(id:MatVal):
    ...
    select = f"b.po_no,b.sl_no,i.item_id,i.quantity,i.discount,i.discount_percent,i.cgst_id,i.sgst_id,i.igst_id,i.item_rt,d.mrn_no,d.prod_id,d.rc_qty"
    schema = f"td_po_basic b left join td_po_items i on b.sl_no=i.po_sl_no join td_item_delivery_details d on d.po_no=b.po_no and d.prod_id=i.item_id"
