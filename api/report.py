...
async def getprojectpoc(id:MatVal):
    ...
    schema = f"td_po_basic b left join td_po_items i on b.sl_no=i.po_sl_no join td_item_delivery_details d on d.po_no=b.po_no and d.prod_id=i.item_id join td_stock_new st.item_id=d.prod_id and st.ref=d.mrn_no"
