...
# );
    ...
    select = f"DISTINCT i.item_id, p.prod_name, i.quantity, d.rc_qty,d.mrn_no,d.invoice,pb.pur_req,v.vendor_name,concat(pd.proj_name,' (ID:',pd.proj_id,')') as proj_name" if id.type=='P' else f"DISTINCT i.item_id, p.prod_name, i.quantity, d.rc_qty,d.mrn_no,d.invoice,pb.pur_req,'Warehouse' as proj_name,v.vendor_name"
