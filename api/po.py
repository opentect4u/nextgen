...
async def getprojectpoc(id:GetPo):
    ...
    schema = "td_siemens_log i left join md_product p on i.prod_id=p.sl_no left join td_item_delivery_details d on d.item_id=i.prod_id left join td_item_delivery_invoice t on t.invoice=d.invoice"
