...
async def getprojectpoc(id:PoSearch):
    ...
    schema = '''td_po_basic b left join td_item_delivery_invoice d on d.po_no = b.po_no left join td_project pr on pr.sl_no = b.proj_id left join td_item_delivery_details i on i.po_no=d.po_no left join md_product p on i.prod_id = p.sl_no left join md_vendor v on v.sl_no=b.vendor_id
'''
