...
async def item_dtls(data:ProjId):
    ...
    where1 = f"a.po_no=b.po_no and a.project_id={data.Proj_id} group by b.prod_id"
    order1 = ""
    flag1 = 1 
...
async def get_item_dtls(data:ProjId):
    ...
    schema1 = "td_po_basic b LEFT JOIN td_po_items c on c.po_sl_no = b.sl_no left join md_product p on c.item_id=p.sl_no left join td_item_delivery_details d on d.prod_id=c.sl_no"
