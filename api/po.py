...
async def getprojectpoc(id:PoSearch):
    ...
    select = "b.po_no,b.sl_no,b.fresh_flag,b.amend_flag,b.project_id,b.vendor_id,v.vendor_name,d.proj_name,b.po_issue_date,i.item_id,p.prod_name,p.prod_make,p.part_no,b.created_by,b.created_at"
