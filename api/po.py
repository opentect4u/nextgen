...
async def addfreshpo(data:PoModel):
    ...
    values2 = f'"{lastID}","{data.price_basis}","{data.price_basis_desc}","{data.packing_fwd_val}","{data.packing_fwd_extra}","{data.packing_fwd_extra_val}","{data.pf_currency}","{data.pf_cgst}","{data.pf_sgst}","{data.pf_igst}","{data.freight_ins}","{data.freight_ins_val}","{data.freight_currency}","{data.freight_cgst}","{data.freight_sgst}","{data.freight_igst}","{data.ins}","{data.ins_val}","{data.test_certificate}","{data.ins_extra}","{data.ins_extra_val}","{data.test_certificate_desc}","{data.ld_date}","{data.ld_date_desc}","{data.ld_val}","{data.ld_val_desc}","{data.ld_val_per}","{data.min_per}","{data.warranty_guaranty}","{data.dispatch_dt}","{data.comm_dt}","{data.duration}","{data.duration_value}","{data.o_m_manual}","{data.operation_installation_desc}","{data.packing_type}","{data.packing_val}","{data.o_m_desc}","{data.operation_installation}","{data.manufacture_clearance}","{data.manufacture_clearance_desc}","{data.user}","{formatted_dt}"'
    table_name2 = "td_po_terms_condition"
    whr2 = f'po_sl_no="{data.sl_no}"' if data.sl_no > 0 else None
    flag2 = 1 if data.sl_no>0 else 0
