...
async def getprojectpoc(data:GetPo):
    ...
    schema = "td_po_items i left join md_product p on i.item_id=p.sl_no left join td_min m on m.item_id=i.sl_no left join on td_item_delivery_details d on d.item_id=i.item_id and m.delete_flag='N'"
