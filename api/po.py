...
async def getprojectpoc(id:PoSearch):
    ...
    schema = '''td_requisition_items i left join left join md_product p ON p.sl_no=i.item_id left join td_project d on b.project_id = d.sl_no left join td_requisition r on r.req_no = i.req_no
'''
