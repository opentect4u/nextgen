...
async def item_dtls(data:ProjId):
    # This is done after hanging
    select1 = f"item_id,prod_name,sl_no prod_id, prod_make,part_no,model_no,article_no,prod_desc,SUM(warehouse_stock)tot_rc_qty,SUM(req_qty)tot_req,(SUM(warehouse_stock) - SUM(req_qty))available,sum(tot_del) as tot_del"
