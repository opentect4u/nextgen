...
async def getprojectpoc(id:GetPo):
    ...
    select = "@a:=@a+1 serial_number,b.po_id,b.po_date,b.po_type as type,b.po_issue_date,b.po_status,IF(b.po_status='P','In progress', IF(b.po_status='U', 'Approval pending',IF(b.po_status='A','Approved',IF(b.po_status='L',IF(b.po_status='D','Delivered',''))))) b.po_status_val, IF(b.po_type='P','Project-Specific', IF(b.po_type='G', 'General','')) b.po_type,b.project_id,p.proj_name,b.vendor_id,b.created_by,b.created_at,b.created_by,b.created_at,b.modified_by,b.modified_at,v.vendor_name,b.sl_no"
