...
async def item_dtls(data:ProjId):
    ...
    select1 = f"SELECT item_id,prod_name,prod_make,part_no,model_no,article_no,prod_desc,SUM(warehouse_stock)tot_rc_qty,SUM(req_qty)tot_req,(SUM(warehouse_stock) - SUM(req_qty))available"
