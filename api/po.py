...
async def item_dtls(data:ProjId):
    ...
    # table1 = "td_po_basic a, md_product c LEFT JOIN td_po_items d ON c.sl_no=d.item_id LEFT JOIN td_item_delivery_details b ON d.sl_no=b.item_id"
    where3 = f"td_transfer t join td_transfer_items b on b.trans_no=t.trans_no join md_product c on b.item_id=c.sl_no where t.to_proj_id = {data.Proj_id} group by prod_id"
    order3 = ""
    flag3 = 1 
