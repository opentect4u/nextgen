...
#     return result
    ...
    schema = '''td_vendor_to_client d left join td_po_basic b on b.po_no = d.po_no left join td_project pr on pr.sl_no = b.project_id left join td_vtoc_items i on i.invoice=d.invoice left join md_product p on i.item_id = p.sl_no left join md_vendor v on v.sl_no=b.vendor_id
