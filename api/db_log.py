...
async def user_log_update(user_id,flag,table_nm,time):
    if flag == 'N':
        activity = 'inserted'
    elif flag == 'E':
        activity = 'updated'
    ...
    narration = f'{user_id} has {activity} to {table_nm} on {time} ' if flag !='I' and flag!='O' else f'user_id has {activity} on {time}'
